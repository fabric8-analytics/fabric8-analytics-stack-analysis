...
def submit_job(input_bootstrap_file, input_src_code_file, training_data_url):
            ...
            },
            {
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                             '--py-files',
                             '/home/hadoop/' + s3_key,
                             '/home/hadoop/analytics_platform/softnet/src/offline_training.py',
                             training_data_url]
                }
            }
        ],
    ...
    if response.get('ResponseMetadata').get('HTTPStatusCode') == 200:
        ...
        output['status_description'] = "The training is in progress. Please check the given training job after some time."
    else:
